package com.hyh.sparkproject.spark.ad;
...
//				.set("spark.streaming.receiver.writeAheadLog.enable", "true");   
		...
		// 2 每隔5秒钟，咱们的spark streaming作业就会收集最近5秒内的数据源接收过来的数据
		...
		// 构建kafka参数map
		// 3 主要要放置的就是，你要连接的kafka集群的地址（broker集群的地址列表）
		...
		//5 两个值，val1，val2；val1没有什么特殊的意义；val2中包含了kafka topic中的一条一条的实时日志数据
